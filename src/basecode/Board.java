...
public class Board extends JPanel implements ActionListener {
    ...
    private Image pacMan = new ImageIcon("src/images/PacManRight.gif")
            .getImage();
    private Image livesIcon = new ImageIcon("src/images/PacManResting.png")
            .getImage();
    private Image pellet = new ImageIcon("src/images/Pellet.png").getImage();
    private Image removedPellet = new ImageIcon("src/images/removedPellet.png")
            .getImage();
    // make a test ghost
    ...
    private Ghost testGhost2 = new Ghost("src/images/blueGhost1.gif", 60, 160,
            6);
...
//         }
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < NUM_BLOCKS; i++) {
            for (int j = 0; j < NUM_BLOCKS; j++) {
                ...
                if (grid2[i][j] == true) {
                    g2d.drawImage(pellet, (i * bSize) + 10, (j * bSize) + 10,
                            this);
                } // draw pellet
                else if (grid2[i][j] == false) {
                    g2d.drawImage(removedPellet, (i * bSize) + 10,
                            (j * bSize) + 10, this);
                } // removes pellet
        ...
        for (int i = 0; i < NUM_BLOCKS; i++) {
            for (int j = 0; j < NUM_BLOCKS; j++) {
                ...
                if (grid[i][j] == -1) {
                    g2d.fillRoundRect((i * bSize) + 10, (j * bSize) + 10, bSize,
                            bSize, 1, 1);
        ...
        // draw the test ghost
        g2d.drawImage(testGhost.getIcon(), testGhost.getGhostX(),
                testGhost.getGhostY(), this);

        g2d.drawImage(blueGhost.getIcon(), blueGhost.getGhostX(),
                blueGhost.getGhostY(), this);

        g2d.drawImage(testGhost2.getIcon(), testGhost2.getGhostX(),
                testGhost2.getGhostY(), this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //
        // if (checkCollision(posX,posY, Ghost.getGhostX(), Ghost.getGhostY())
        // == true){
        // livesLeft--;
        // if (livesLeft == 0) {
        // inGame = false;
